...
.telegram:hover {
  background-image: url("../../../assets/footer/Technician_Hovered/Telegram.svg");
}
.twitter:hover {
  background-image: url("../../../assets/footer/Technician_Hovered/Twitter.svg");
}
.linkedin:hover {
  background-image: url("../../../assets/footer/Technician_Hovered/Linkedin.svg");
}
.instagram:hover {
  background-image: url("../../../assets/footer/Technician_Hovered/Instagram.svg");
}
